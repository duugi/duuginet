...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { description: @library.description, is_active: @library.is_active, name: @library.name, slug: @library.slug } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { description: @library.description, is_active: @library.is_active, name: @library.name, slug: @library.slug } }
